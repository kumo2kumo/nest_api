...
import { EventFeeUncheckedCreateNestedManyWithoutClubInput } from '../event-fee/event-fee-unchecked-create-nested-many-without-club.input';

@InputType()
export class ClubUncheckedCreateWithoutMembershipFeesInput {
    ...
    @Field(() => EventFeeUncheckedCreateNestedManyWithoutClubInput, {nullable:true})
    eventFees?: EventFeeUncheckedCreateNestedManyWithoutClubInput;
}
