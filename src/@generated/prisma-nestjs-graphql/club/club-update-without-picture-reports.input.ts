...
import { MemberUpdateManyWithoutClubInput } from '../member/member-update-many-without-club.input';
...
@InputType()
export class ClubUpdateWithoutPictureReportsInput {
    ...
    @Field(() => MemberUpdateManyWithoutClubInput, {nullable:true})
