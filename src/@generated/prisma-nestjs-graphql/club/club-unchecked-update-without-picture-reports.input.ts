...
import { ReportUncheckedUpdateManyWithoutClubInput } from '../report/report-unchecked-update-many-without-club.input';
...
@InputType()
export class ClubUncheckedUpdateWithoutPictureReportsInput {
    ...
    @Field(() => ReportUncheckedUpdateManyWithoutClubInput, {nullable:true})
    reports?: ReportUncheckedUpdateManyWithoutClubInput;
