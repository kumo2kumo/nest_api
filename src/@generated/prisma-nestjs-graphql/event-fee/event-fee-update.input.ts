...
import { UserUpdateOneRequiredWithoutEventFeesInput } from '../user/user-update-one-required-without-event-fees.input';
import { ClubUpdateOneRequiredWithoutEventFeesInput } from '../club/club-update-one-required-without-event-fees.input';

@InputType()
export class EventFeeUpdateInput {
    ...
    @Field(() => UserUpdateOneRequiredWithoutEventFeesInput, {nullable:true})
    user?: UserUpdateOneRequiredWithoutEventFeesInput;

    @Field(() => ClubUpdateOneRequiredWithoutEventFeesInput, {nullable:true})
