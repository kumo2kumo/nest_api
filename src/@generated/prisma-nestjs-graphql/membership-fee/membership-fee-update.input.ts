...
import { UserUpdateOneRequiredWithoutMembershipFeesInput } from '../user/user-update-one-required-without-membership-fees.input';
import { ClubUpdateOneRequiredWithoutMembershipFeesInput } from '../club/club-update-one-required-without-membership-fees.input';

@InputType()
export class MembershipFeeUpdateInput {
    ...
    @Field(() => UserUpdateOneRequiredWithoutMembershipFeesInput, {nullable:true})
    user?: UserUpdateOneRequiredWithoutMembershipFeesInput;

    @Field(() => ClubUpdateOneRequiredWithoutMembershipFeesInput, {nullable:true})
