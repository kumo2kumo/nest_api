...
import { UniformOwnerUncheckedCreateNestedManyWithoutUserInput } from '../uniform-owner/uniform-owner-unchecked-create-nested-many-without-user.input';
...
@InputType()
export class UserUncheckedCreateWithoutUpdateSledCommentsInput {
    ...
    @Field(() => UniformOwnerUncheckedCreateNestedManyWithoutUserInput, {nullable:true})
    uniformOwners?: UniformOwnerUncheckedCreateNestedManyWithoutUserInput;
