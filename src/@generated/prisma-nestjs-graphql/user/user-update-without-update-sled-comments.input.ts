...
import { EventFeeUpdateManyWithoutUserInput } from '../event-fee/event-fee-update-many-without-user.input';
import { MembershipFeeUpdateManyWithoutUserInput } from '../membership-fee/membership-fee-update-many-without-user.input';

@InputType()
export class UserUpdateWithoutUpdateSledCommentsInput {
    ...
    @Field(() => EventFeeUpdateManyWithoutUserInput, {nullable:true})
