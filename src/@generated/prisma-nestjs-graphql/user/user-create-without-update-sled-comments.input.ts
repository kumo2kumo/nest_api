...
import { EventFeeCreateNestedManyWithoutUserInput } from '../event-fee/event-fee-create-nested-many-without-user.input';
...
@InputType()
export class UserCreateWithoutUpdateSledCommentsInput {
    ...
    @Field(() => EventFeeCreateNestedManyWithoutUserInput, {nullable:true})
