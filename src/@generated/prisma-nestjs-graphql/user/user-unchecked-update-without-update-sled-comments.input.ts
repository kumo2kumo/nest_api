...
import { UniformOwnerUncheckedUpdateManyWithoutUserInput } from '../uniform-owner/uniform-owner-unchecked-update-many-without-user.input';
...
@InputType()
export class UserUncheckedUpdateWithoutUpdateSledCommentsInput {
    ...
    @Field(() => UniformOwnerUncheckedUpdateManyWithoutUserInput, {nullable:true})
    uniformOwners?: UniformOwnerUncheckedUpdateManyWithoutUserInput;
